...
public class Tests
{
    ...
    public void TypeSafeLoad()
    {
        ...
        var criteria = LoadCriteria.FromExpressions<Contact>(
            c => c.Name == "Test User" && c.Id == id,
            null,
            null,
            new[]
            {
    ...
    public async Task GetResultWithGroupsAndAggregates()
    {
        ...
        var results = await LoadCriteriaExtensions.GetCriteriaResult(
        ...
        results.FinalItems.Should().NotBeEmpty();
    ...
    public void VerifyEmptyFilterCriteria()
    {
        ...
        Assert.Throws<InvalidOperationException>(
            () => contacts.AsQueryable().ApplyLoadCriteria(criteria)
        );
    }
