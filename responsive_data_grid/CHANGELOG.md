...
- Per-column `rowspan` / `rowspanFor` hide consecutive equal formatted body cells on the ungrouped pager (not a stretched HTML rowspan). `colspan` occupies adjacent body columns in table layout (headers stay 1:1).
